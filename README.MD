...
Instead of 10 experts, I decided on 6 (my reasoning for 6 was based loosely on the structure of convolutional neural networks (CNNs) -- the state of the art in image recognition).
